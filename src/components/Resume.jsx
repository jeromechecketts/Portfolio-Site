...
const Resume = ({ classicHeader, darkTheme }) => {
  const educationDetails = [
    ...
    },
    {
      ...
      place: "NuCamp Coding Bootcamp",
      desc: "Learned data structures and algorithms to build robust applications with Python and SQL. Used DevOps tools and deploy to the cloud platforms.",
    },
    {
      yearRange: "2008 - 2010",
      ...
      <div className={"container " + (classicHeader ? "" : "px-lg-5")}>
        ...
        <div className="row gx-5 d-flex">
          ...
          <div className="col-md-12">
            <h2
              className={
                "text-center text-6 fw-600 mb-4 " + (darkTheme ? "text-white" : "")
              }
            >
              My Education
            </h2>
        ...
        <h2
          className={
            "text-center text-6 fw-600 mt-4 mb-4 " + (darkTheme ? "text-white" : "")
          }
        >
          My Skills
        </h2>
        <div className="row gx-5 d-flex pl-3">
          {skills.length > 0 &&
            skills.map((skill, index) => (
              <div key={index} className="col-md-3 justify-content-around">
                <p
                  className={
